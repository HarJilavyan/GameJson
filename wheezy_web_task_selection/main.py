...
class Users():
    ...
    def changeRoles(self,login,role) -> object:
        self.cursor.execute(
              """
                UPDATE users
                SET rights = :role
    ...
    def insertErrors(self, user_id, error, fixed) -> object:
        self.cursor.execute(
            """
    ...
    def getError(self, user_id) -> object:
        self.cursor.execute(
            """
    ...
    def updateErrors(self, user_id, error, fixed) -> object:
        self.cursor.execute(
            """
                UPDATE error_list
                SET fixed = :fixed
    ...
    ####################################################################
    def postRequests(self,login,request) -> object:
        self.cursor.execute(
            """
                UPDATE users
                SET request = :request
